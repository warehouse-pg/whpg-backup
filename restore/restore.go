...
func DoSetup() {
	SetLoggerVerbosity()
	gplog.Verbose("Debug_NS: DoSetup() Restore Command: %s", os.Args)

	gplog.Info("Debug_NS: DoSetup() Restore Command: %s", os.Args)
	...
	gplog.Info("Debug_NS: DoSetup() - version variable = %s", version)
